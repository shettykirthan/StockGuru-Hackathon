...
client.set_project("674163a40005a9daa83c")  # Your Project ID

account = Account(client)
# Initialize Databases Service
databases = Databases(client)

DATABASE_ID = "6741641a00349058b3c2"  # Your Database ID
COLLECTION_ID = "674166ec0034c7a175d0"  # Your Collection ID
